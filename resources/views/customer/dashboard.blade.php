    ...
    <header class="bg-gray-800 text-white py-4">
        <div class="max-w-7xl mx-auto px-4 flex justify-between items-center">
            ...
            <form method="POST" action="{{ route('customer.logout') }}">
                @csrf
                <button class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600"><a href="{{route('posts.create')}}" style="text-decoration: none">Customer Blog Post</a></button>
                <button type="submit"
